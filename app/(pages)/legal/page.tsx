    ...
    <main>
      <section className="py-20 pt-[160px]">
        <div className="container flex flex-col items-center gap-16">
          <h1 className="text-foreground/85 text-h1 text-start w-full">
            Boring Legal Stuff
          </h1>
          {/* Privacy Policy */}
          <div className="flex flex-col text-start w-full text-foreground/85 gap-8">
            <h2 className="text-h2">Privacy Policy</h2>
            <p>
              This Privacy Policy describes how your personal information is
              collected, used, and shared when you visit or make a purchase from
              levarestudio.com (the “Site”).
            </p>
            <h3 className="text-p">Personal Information We Collect</h3>
            ...
            <h3 className="text-p">How Do We Use Your Personal Information?</h3>
            ...
            <h3 className="text-p">Sharing Your Personal Information</h3>
            <p>
            ...
            <h3 className="text-p">Do Not Track</h3>
            <p>
            ...
            <h3 className="text-p">Your Rights</h3>
            <p>
            ...
            <h3 className="text-p">Data Retention</h3>
            <p>
            ...
            <h3 className="text-p">Changes</h3>
            <p>
            ...
            <h3 className="text-p">Contact Us</h3>
            <p>
              For more information about our privacy practices, if you have
              questions, or if you would like to make a complaint, please
              contact us by e-mail at hello@levarestudio.com
            </p>
          </div>
          {/* Terms of Service */}
          <div className="flex flex-col text-start w-full text-foreground/85 gap-8">
            <h2 className="text-h2">Terms of Service</h2>
            <h2 className="text-p">Overview</h2>
            <p>
              This website is operated by Levare Studio. Throughout the site,
              the terms “we”, “us” and “our” refer to Levare Studio. Levare
              Studio offers this website, including all information, tools and
            ...
            {/*  */}
            <h2 className="text-p">Section 1 - Online Store Terms</h2>
            <p>
            ...
            {/*  */}
            <h2 className="text-p">Section 2 - General Condition</h2>
            <p>
            ...
            {/*  */}
            <h2 className="text-p">Section 7 - Optional Tools</h2>
            <p>
            ...
            {/*  */}
            <h2 className="text-p">Section 8 - Third-Party Links</h2>
            <p>
            ...
            {/*  */}
            <h2 className="text-p">Section 10 - Personal Information</h2>
            <p>
            ...
            {/*  */}
            <h2 className="text-p">Section 12 - Prohibited Uses</h2>
            <p>
            ...
            <p>
              In no case shall Levare Studio, our directors, officers,
            ...
            {/*  */}
            <h2 className="text-p">Section 14 - Indemnification</h2>
            <p>
              You agree to indemnify, defend and hold harmless Levare Studio and
            ...
            {/*  */}
            <h2 className="text-p">Section 15 - Severability</h2>
            <p>
            ...
            {/*  */}
            <h2 className="text-p">Section 16 - Termination</h2>
            <p>
            ...
            {/*  */}
            <h2 className="text-p">Section 17 - Entire Agreement</h2>
            <p>
            ...
            {/*  */}
            <h2 className="text-p">Section 19 - Contact Information</h2>
            <p>
              Questions about the Terms of Service should be sent to us at
              hello@levarestudio.com
            </p>
          </div>
        </div>
      </section>
